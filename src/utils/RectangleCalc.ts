export const rectangleSquare = (div: HTMLDivElement | null) => {
    const calcNav = div;
...
export const rectanglePerimeter = (div: HTMLDivElement | null) => {
    const calcNav = div;
    let calcNavChildren: Array<any>;
    let childNode: Array<any>;
    childNode = [];
...
export const rectangleDiagonal = (div: HTMLDivElement | null) => {
    const calcNav = div;
    let calcNavChildren: Array<any>;
    let childNode: Array<any>;
    childNode = [];
